...
import java.io.*;
	...
	/////////////////////////////////////////////////////////////////////////////////////////////////////////////
        ...
        g.addVertex("Bopodi");
        g.addVertex("Khadki");
        g.addVertex("Range Hills");
        g.addVertex("Shivajinagar");
        ...
        g.addEdge("PCMC", "Phugewadi", 3);
        g.addEdge("Phugewadi", "Dapodi", 2);
        g.addEdge("Dapodi", "Bopodi", 2);
        g.addEdge("Bopodi", "Khadki", 2);
        g.addEdge("Khadki", "Range Hills", 2);
        g.addEdge("Range Hills", "Shivajinagar", 3);
        g.addEdge("Shivajinagar", "Civil Court", 2);
        g.addEdge("Civil Court", "Mangalwar Peth", 2);
        g.addEdge("Mangalwar Peth", "Pune Railway Station", 2);
        g.addEdge("Pune Railway Station", "Swargate", 3);
